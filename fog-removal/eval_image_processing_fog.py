...
FOLDER_CONFIGS = {
    "fog_unprocessed": {
        "input_images": "./fog_dataset/input_images/unprocessed_images",
        "annotations": "./fog_dataset/labels.json",
        "output_images": "./fog_dataset/output_images/unprocessed_images",
        "description": "Fog Removal - Unprocessed Images",
    },
    "fog_kim_pipeline": {
        "input_images": "./fog_dataset/input_images/kim_pipeline_images",
        "annotations": "./fog_dataset/labels.json",
        "output_images": "./fog_dataset/output_images/kim_pipeline_images",
        "description": "Fog Removal - Kim Pipeline Images",
    },
    "fog_dcp": {
        "input_images": "./fog_dataset/input_images/dcp_images",
        "annotations": "./fog_dataset/labels.json",
        "output_images": "./fog_dataset/output_images/dcp_images",
