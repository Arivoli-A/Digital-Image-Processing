...
FOLDER_CONFIGS = {
    "low_light_unprocessed": {
        "input_images": "./low-light/ground_truth/test",
        "annotations": "./low-light/ground_truth/test/instances_default_test_bdd100k.json",
        "output_images": "./low-light/outputs/ground_truth/",
        "description": "Low Light - Unprocessed Images"
    },
     "low_light_bimef": {
        "input_images": "./low-light/BIMEF/",
        "annotations": "./low-light/BIMEF/instances_default_processed_bdd100k.json",
        "output_images": "./low-light/outputs/BIMEF",
        "description": "BIMEF"
    },
     "low_light_lime": {
        "input_images": "./low-light/LIME",
        "annotations": "./low-light/BIMEF/instances_default_processed_bdd100k.json",
        "output_images": "./low-light/outputs/LIME",
        "description": "LIME"
    },
    # "low_light_finetuned": {
    #     "input_images": "./low-light/ground_truth/test",
    #     "annotations": "./low-light/ground_truth/test/instances_default_test_bdd100k.json",
    #     "output_images": "./low-light/outputs/fine_tune/",
    #     "description": "Low Light - Finetuned Model"
    # },
}
    ...
    for cat_id, cat_name in enumerate(CLASSES, start=1):
        ...
        try:
            ...
            if coco_eval.stats is not None and len(coco_eval.stats) >= 12:
                ...
                all_metrics[cat_name] = {k: 0.0 for k in [
...
def save_results(all_results):
    ...
    print("SUMMARY")
    print("="*80)
    print(f"{'Folder':<35} {'Imgs':<6} {'Preds':<7} {'AP':<7} {'AP50':<7} {'AP75':<7} {'AR1':<7} {'AR10':<7} {'AR100':<7}")
    print("-"*80)
    for item in summary:
        print(f"{item['description']:<35} {item['num_images']:<6} {item['num_predictions']:<7} "
