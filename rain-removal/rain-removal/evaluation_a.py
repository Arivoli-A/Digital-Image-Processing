...
FOLDER_CONFIGS = {
    "images_pre_processed": {
        "input_images": "./rain-removal/images_pre_processed",
        "annotations": "./rain-removal/rain_annotations.json",
        "output_images": "./rain-removal/unprocessed_images",
        "description": "Rain Removal - Unprocessed Images"
    },
    "images_processed": {
        "input_images": "./rain-removal/images_processed",
        "annotations": "./rain-removal/rain_annotations.json",
        "output_images": "./rain-removal/processed_images",
        "description": "Fog Removal - Kim Pipeline Images"
    },
    # "fog_dcp": {
    #     "input_images": "./fog-removal/input_images/dcp_images",
    #     "annotations": "./fog-removal/labels.json",
    #     "output_images": "./fog-removal/output_images/dcp_images",
    #     "description": "Fog Removal - DCP Images"
    # },
    # "label2_folder1": {
    #     "input_images": "path/to/label2/folder1/images",
    #     "annotations": "path/to/label2/folder1/annotations.json",
    #     "output_images": "evaluation_results/label2_folder1_viz",
    #     "description": "Label 2 - Folder 1"
    # },
    # "label2_folder2": {
    #     "input_images": "path/to/label2/folder2/images",
    #     "annotations": "path/to/label2/folder2/annotations.json",
    #     "output_images": "evaluation_results/label2_folder2_viz",
    #     "description": "Label 2 - Folder 2"
    # },
    # "label2_folder3": {
    #     "input_images": "path/to/label2/folder3/images",
    #     "annotations": "path/to/label2/folder3/annotations.json",
    #     "output_images": "evaluation_results/label2_folder3_viz",
    #     "description": "Label 2 - Folder 3"
    # },
    # "label3_folder1": {
    #     "input_images": "path/to/label3/folder1/images",
    #     "annotations": "path/to/label3/folder1/annotations.json",
    #     "output_images": "evaluation_results/label3_folder1_viz",
    #     "description": "Label 3 - Folder 1"
    # },
    # "label3_folder2": {
    #     "input_images": "path/to/label3/folder2/images",
    #     "annotations": "path/to/label3/folder2/annotations.json",
    #     "output_images": "evaluation_results/label3_folder2_viz",
    #     "description": "Label 3 - Folder 2"
    # },
    # "label3_folder3": {
    #     "input_images": "path/to/label3/folder3/images",
    #     "annotations": "path/to/label3/folder3/annotations.json",
    #     "output_images": "evaluation_results/label3_folder3_viz",
    #     "description": "Label 3 - Folder 3"
    # },
}
...
def run_inference_and_save(predictor, annotations_path, input_image_dir, output_json, output_image_dir, metadata, save_viz=True):
...
def compute_metrics(annotations_path, predictions_json):
    """Compute AP metrics for all classes"""
    ...
    for cat_id, cat_name in enumerate(CLASSES, start=1):
        ...
        try:
            ...
            if coco_eval.stats is not None and len(coco_eval.stats) >= 6:
                ...
                all_metrics[cat_name] = {k: 0.0 for k in ['AP', 'AP50', 'AP75', 'APs', 'APm', 'APl']}
        except Exception as e:
            sys.stdout = old_stdout
            all_metrics[cat_name] = {k: 0.0 for k in ['AP', 'AP50', 'AP75', 'APs', 'APm', 'APl']}
...
def save_results(all_results):
    ...
    print("SUMMARY")
    print("="*80)
    print(f"{'Folder':<30} {'Images':<8} {'Preds':<8} {'Viz':<8} {'AP':<8} {'AP50':<8} {'AP75':<8}")
    print("-"*80)
    for item in summary:
        print(f"{item['description']:<30} {item['num_images']:<8} {item['num_predictions']:<8} "
              f"{item['num_visualizations']:<8} {item['AP']:<8.2f} {item['AP50']:<8.2f} {item['AP75']:<8.2f}")
